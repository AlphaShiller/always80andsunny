...
export async function POST(request: NextRequest) {
  try {
    ...
    const appUrl = process.env.NEXT_PUBLIC_APP_URL || "https://always80-one.vercel.app";
        ...
        line_items: [
          {
            price_data: {
              currency: "usd",
              product_data: {
                name: `Always 80 and Sunny — ${tierName} Tier`,
                description: `Monthly subscription to ${tierName} tier on Always 80 and Sunny`,
              },
        ...
        line_items: [
          {
            price_data: {
              currency: "usd",
              product_data: {
                name: `Always 80 and Sunny — ${tierName}`,
